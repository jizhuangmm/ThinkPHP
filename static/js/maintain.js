	...
	*/
	...
	$('.maintain,.vindicate').on("click", ".check", function () {
		if($(this).find('input').is(':checked')){
			$(this).children('span').css('background','url("/static/img/img_xr/jihuagoc_03.png") no-repeat');
			$(this).siblings().children('span').css('background','url("/static/img/img_xr/pic_03.gif") no-repeat');
		}
	});
