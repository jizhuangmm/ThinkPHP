         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('activity_list');?>">资讯列表</a>
                        ...
                        <div class="widget-body">
                           ...
                           <table border="2" width="100%" align="center">
								...
								<?php if(is_array($checkList)): foreach($checkList as $key=>$list): ?><tr align="center">
										...
										<th><?php echo ($list['dealer_name']); ?></th>
										<th><?php echo ($list['brief']); ?></th>
										<th><?php echo ($list['author']); ?></th>
										<th><?php echo ($list['area']); ?></th>
										<th><?php echo ($list['time']); ?></th>
										<th><?php echo ($list['type']); ?></th>
										<th><a href="<?php echo U('activity/activity_audit?id='.$list['id']);?>">通过</a>|<a href="<?php echo U('activity/activity_audit?id='.$list['id'].'&draft='.$list['draft']);?>">不通过</a></th>
									</tr><?php endforeach; endif; ?>
								<tr>
									<td colspan="3">
										<button id="all" class="btn">全选</button>
										<button id="uncheck" class="btn">清除</button>
										<input type="button" class="btn" value="一键通过">
									</td>
									<td colspan="6" align="right"><?php echo ($show); ?></td>
   ...
   <script type="text/javascript" charset="utf-8">
	$(function(){
		...
		$('input:button').click(function(){
            ...
            location.href='<?php echo U("activity_audit");?>?'+data;
			});
