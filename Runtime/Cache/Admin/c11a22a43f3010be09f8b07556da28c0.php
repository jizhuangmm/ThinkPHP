         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('cartool/offer_consulting');?>">返回</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('cartool/offer_info');?>" method="post" id="form" class="form-horizontal" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">车薪</label>
                                <div class="controls">
                                    <input type="text" class="span6 " name="car_price" value=""/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="province_ip" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="city_ip" value=""/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  popovers" data-trigger="hover" name="buy_name" value=""/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">称谓</label>
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="appellation" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="contact_way" value="" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">咨询底价</label>
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="low_price" value=""/>
                                </div>
                            </div>
