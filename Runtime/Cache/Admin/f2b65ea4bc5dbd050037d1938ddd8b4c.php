         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('set_time');?>">设置</a>
                       </li>
                   </ul>
               </div>
            </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
					 <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 预约试驾 </h4>
                            <span class="tools">
                          ...
                          <table border="2" width="100%" align="center">
							...
							<?php if(is_array($driveList)): foreach($driveList as $key=>$list): ?><tr align="center">
									<td><?php echo ($list['car_type']); ?></td>
									<td><?php echo ($list['dealer_name']); ?></td>
									<td><?php echo ($list['test_time']); ?></td>
									<td><?php echo ($list['province']); ?></td>
									<td><?php echo ($list['city']); ?></td>
									<td><?php echo ($list['test_person']); ?></td>
									<td><?php echo ($list['mobile']); ?></td>
									<td>
									<input id="over" style="border:0px;width:50px; background-color:white;"  value="待联系"/><br/>
									<a href="<?php echo U('drive_del?id='.$list['id']);?>">删除</a>
									</td>
