         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('first_drive');?>">返回</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 留资页 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('cartool/leave_info');?>" method="post" id="form" class="form-horizontal" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">可试驾车型</label>
                                <div class="controls">
                                    <input type="text" class="span6 " name="car_type" value=""/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="province_ip" value="<?php echo ($info['province_ip']); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="city_ip" value="<?php echo ($info['city_ip']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  popovers" data-trigger="hover" name="dealer_name" value="<?php echo ($info['dealer_name']); ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">试驾人员姓名</label>
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="test_name" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="mobile" value="" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">试驾时间</label>
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="test_time" value="<?php echo ($info['test_time']); ?>"/>
                                </div>
                            </div>
