                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                           ...
                           <table border="2" width="100%" align="center">
								...
								<?php if(is_array($draftList)): foreach($draftList as $key=>$list): ?><tr align="center" >
									...
									<td><a href="<?php echo U('draft_save?id='.$list['id']);?>">编辑</a>|<a href="<?php echo U('draft_del?id='.$list['id']);?>">删除</a></td>
								 
								</tr><?php endforeach; endif; ?>
								<tr>
									<td colspan="9">
										<button id="all" class="btn">全选</button>
										<button id="uncheck" class="btn">清除</button>
										<button id="othercheck" class="btn">反选</button>
   ...
   <script type="text/javascript" charset="utf-8">
	$(function(){
		...
		$('input:button').click(function(){
            ...
            location.href='<?php echo U("draft_del");?>?'+data;
			});
