         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('tpl_define');?>">自定义模板</a>
                           <span class="divider">/</span>
                       </li>
                       <li>
                           <a href="<?php echo U('tpl_download');?>">模板下载</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>当前模板</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('template');?>" class="form-horizontal" method="post">
								<div class="control-group">
									<label class="control-label">字段</label>
									<div class="controls">
									<?php  if($data){ ?>
										<?php if(is_array($data)): foreach($data as $key=>$list): ?><input type="hidden" name="id" value="<?php echo ($id['id']); ?>">
											<p><input type="text" class="span6 " name="new[]" value="<?php echo ($list); ?>"/></p><?php endforeach; endif; ?>
									<?php
 }else{ ?>	
										<p>标题</p>								
										<p>经销商名称</p>								
