         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('activity_finish_add');?>">添加</a>
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
							...
							<table border="1" width="900px" align="center">
								...
								<?php if(is_array($dpList)): foreach($dpList as $key=>$list): ?><tr align="center">
									...
									<td colspan="4"><a href="<?php echo U('activity_dp?id='.$list['id'].'&display_status='.$list['display_status']);?>">显示</a></td>
