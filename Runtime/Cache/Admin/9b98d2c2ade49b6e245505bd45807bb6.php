                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 资讯活动 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                           ...
                           <form action="<?php echo U('activity_finish_add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						   <?php  if($data){ ?>
								<?php if(is_array($data)): foreach($data as $key=>$field): ?><div class="control-group">
										<label class="control-label"><?php echo ($field); ?></label>
										<div class="controls">
										<input type="hidden" name="field[]" value="<?php echo ($field); ?>">
										<input type="text" class="span6 " name="cont[]"/>
						   ...
						   <?php
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6 " name="dealer_name"/>
										<span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group">
								 ...
								 <div class="control-group">
									<label class="control-label">车型底价</label>
									<div class="controls">
										<input type="text" class="span6 " style="margin: 0 auto;" name="low_price"/>
									</div>
								</div>
								 <div class="control-group">
									<label class="control-label">优惠价格</label>
									<div class="controls">
										<input type="text" class="span6 " style="margin: 0 auto;" name="pref_price"/>
									</div>
								</div>
							<?php
 } ?>
