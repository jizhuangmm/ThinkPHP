         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('dealers_list');?>">经销商列表</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('dealer_save');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">经销商代码</label>
                                <div class="controls">
                                    <input type="text" class="span6 " name="code" value="<?php echo ($dealerList['code']); ?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="abb_web" value="<?php echo ($dealerList['abb_web']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="company" value="<?php echo ($dealerList['company']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="dealer_name" value="<?php echo ($dealerList['dealer_name']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="licence_plate" value="<?php echo ($dealerList['licence_plate']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
								<?php
 if($dealerList['subbranch']==0){ ?>
								<input type="radio" name="subbranch[]" value="0" checked="checked">否
								<input type="radio" name="subbranch[]" value="1" >是
								<?php
 }else if($dealerList['subbranch']==1){ ?>
									<input type="radio" name="subbranch[]" value="0" >否
									<input type="radio" name="subbranch[]" value="1" checked="checked">是
								<?php
 } ?>
                                    <span class="help-inline"></span>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="province" value="<?php echo ($dealerList['province']); ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">城市</label>
                                <div class="controls">
                                    <input type="text" class="span6  popovers" data-trigger="hover" name="city" value="<?php echo ($dealerList['city']); ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">地区</label>
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="district" value="<?php echo ($dealerList['district']); ?>"/>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label">详细地址</label>
                                <div class="controls">
                                    <input class="span6 " type="text" name="address" value="<?php echo ($dealerList['address']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="postcode" value="<?php echo ($dealerList['postcode']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="sell_mobile" value="<?php echo ($dealerList['sell_mobile']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                            
                            <div class="form-actions">
								<input type="hidden" name="id" value="<?php echo ($dealerList['id']); ?>">
