         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('activity_list');?>">活动列表</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('activity_add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="brief" />
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="type"/>
                                </div>
                            </div>
                            
                            <div class="form-actions">
                                <input type="submit" class="btn btn-success" value="添加活动">
