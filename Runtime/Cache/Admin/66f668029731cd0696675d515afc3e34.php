...
<div class="row-fluid">
  <div class="span12">
	...
	<ul class="breadcrumb">
	   <li>
		   <a href="<?php echo U('dealer_add');?>">添加</a>
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
							...
							<?php if(is_array($dealerList)): foreach($dealerList as $key=>$list): ?><tr align="center">
									...
									<td><a href="<?php echo U('dealers/display_status?id='.$list['id'].'&display_status='.$list['status']);?>">显示</a>|<a href="<?php echo U('dealers/dealer_save?id='.$list['id']);?>">编辑</a>|<a href="<?php echo U('dealers/dealer_del?id='.$list['id']);?>">删除</a></td>
