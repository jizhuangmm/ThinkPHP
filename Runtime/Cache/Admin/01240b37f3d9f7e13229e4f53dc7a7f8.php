...
<body class="fixed-top">
          ...
          <li class="sub-menu">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('dealer_add');?>"><font>添加</font></a>
                           <span class="divider">/</span>
                       </li>
					    <li>
                           <a href="<?php echo U('dealer_add_all');?>">批量添加</a>
                           <span class="divider">/</span>
                       </li>
                       <li>
                           <a href="<?php echo U('undisplay');?>">显示隐藏信息</a>
                          
                       </li>
                        <li class="pull-right search-wrap">
                           <form action="<?php echo U('dealers_list');?>" method="get" class="hidden-phone">
                               <div class="input-append search-input-area">
                                   <td colspan="13" align="center"><input type="text" name="search" placeholder="请输入经销商名称" value="<?php echo ((isset($_GET['search']) && ($_GET['search'] !== ""))?($_GET['search']):''); ?>">
								   <button>搜索</button></td>
                           </form>
                       </li>
 ...
 if(empty($dealerList)){ ?>
                           ...
                           <table border="2" width="100%" align="center">
							...
							<?php if(is_array($dealerList)): foreach($dealerList as $key=>$list): ?><tr align="center">
									<td><input type="checkbox" name="id[]" value="<?php echo ($list['id']); ?>"><?php echo ($list['id']); ?></td>
									<td><?php echo ($list['code']); ?></td>
									<td><?php echo ($list['abb_web']); ?></td>
									<td><?php echo ($list['company']); ?></td>
									<td><?php echo ($list['dealer_name']); ?></td>
									<td><?php echo ($list['licence_plate']); ?></td>
									<td><?php echo ($list['province']); ?></td>
									<td><?php echo ($list['city']); ?></td>
									<td><?php echo ($list['district']); ?></td>
									<td><?php echo ($list['address']); ?></td>
									<td><?php echo ($list['postcode']); ?></td>
									<td><?php echo ($list['sell_mobile']); ?></td>
									
									<td><a href="<?php echo U('dealers/display_status?id='.$list['id'].'&display_status='.$list['display_status']);?>">隐藏</a>|<a href="<?php echo U('dealers/dealer_save?id='.$list['id']);?>">编辑</a>|<a href="<?php echo U('dealers/dealer_del?id='.$list['id']);?>">删除</a>
							 ...
							 <tr>
								...
								<td><button id="othercheck">反选</button></td> -->
								 <td ><input type="button" class="btn" value="全部删除"></td>
								 <td colspan="17" align="right"><?php echo ($show); ?></td>
							</tr>
						</table>
						<?php
 } ?>
   ...
   <script type="text/javascript" charset="utf-8">
	$(function(){
		...
		$('input:button').click(function(){
            ...
            location.href='<?php echo U("dealer_del");?>?'+data;
			});
