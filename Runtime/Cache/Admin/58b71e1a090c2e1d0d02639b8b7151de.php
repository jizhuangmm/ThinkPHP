...
<body class="fixed-top">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('activity_list');?>">返回</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 活动编辑 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo U('activity_save');?>" method="post" class="form-horizontal" >
							
							<?php  if($data){ ?>
							<?php $__FOR_START_8618__=0;$__FOR_END_8618__=count($data[0]);for($i=$__FOR_START_8618__;$i < $__FOR_END_8618__;$i+=1){ ?><div class="control-group">
                                <label class="control-label"><?php echo ($data[0][$i]); ?></label>
                                <div class="controls">
                                    <input type="text" class="span6 " name="content[]" value="<?php echo ($data[1][$i]); ?>"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                   <input type="text" class="span6 " style="margin: 0 auto;" name="time" value="<?php echo date('Y-m-d H:i:s');?>" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                                </div>
                            </div>
							 <div class="control-group">
                                <label class="control-label">内容简介</label>
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="brief" value="<?php echo ($info['brief']); ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">区域</label>
                                <div class="controls">
                                    <input type="text" class="span6  tooltips" data-trigger="hover" name="area" value="<?php echo ($info['area']); ?>"/>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label">经销商</label>
                                <div class="controls">
                                    <input type="text" class="span6 " style="margin: 0 auto;" name="dealer_name" value="<?php echo ($info['dealer_name']); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6  popovers" data-trigger="hover" name="author" value="<?php echo ($info['author']); ?>"/>
                                </div>
                            </div>
                            <?php
 } ?>
 ...
 if($data){ ?>
							...
							<?php
								...
								<input type="submit" name="sub" class="btn"  value="更改">
