...
<body class="fixed-top">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="span6 " type="text" name="summary" value="<?php echo ($draft['summary']); ?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
									<img id="img" src="/ftms/<?php echo ($draft['thumb_img']); ?>" width="80px">
									<input type="file" name="image" onchange="fileChange(this)">
                            ...
                            <div class="form-actions">
								...
								<input type="hidden" name="simg" value="<?php echo ($draft['thumb_img']); ?>">
								<button type="button"  id ="but" class="btn">更改</button>
  ...
  <script type="text/javascript" src="/ftms/static/My97DatePicker/WdatePicker.js"> </script> 
   <script src="/ftms/static/jQuery/jQuery-1.12.3.js"></script>
 <script>
	
		function fileChange(othis){
		//创建图片路径
			var url = window.URL.createObjectURL(othis.files[0]);
			//查找当前节点的下一个兄弟节点
			//var img = othis.nextSibling;
			//设置属性
			$('#img').attr('src',url);
