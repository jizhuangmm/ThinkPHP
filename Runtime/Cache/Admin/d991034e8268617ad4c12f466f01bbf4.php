         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="<?php echo U('information/info_finish_add');?>">添加</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 资讯列表 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                           ...
                           <table border="2" width="100%" align="center">
							...
							<?php if(is_array($infoList)): foreach($infoList as $key=>$list): ?><tr align="center">
									...
									<td colspan="4"><a href="<?php echo U('info_save?id='.$list['id']);?>">编辑</a>|<a href="<?php echo U('info_del?id='.$list['id']);?>">删除</a>|<a href="<?php echo U('information/info_recommend?id='.$list['id']);?>">推荐</a>|<a href="<?php echo U('information/check?id='.$list['id'].'&check_status='.$list['check_status']);?>">取消通过</a></td>
   ...
   <script type="text/javascript" charset="utf-8">
	$(function(){
		...
		$('input:button').click(function(){
            ...
            location.href='<?php echo U("info_del");?>?'+data;
			});
