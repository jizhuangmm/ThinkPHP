    ...
    <div class="sidebar-scroll">
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
					 <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 报价咨询 </h4>
                            <span class="tools">
                          ...
                          <table border="2" width="100%" align="center">
							...
							<?php if(is_array($priceList)): foreach($priceList as $key=>$list): ?><tr align="center">
									
									<td><?php echo ($list['car_price']); ?></td>
									<td><?php echo ($list['dealer_name']); ?></td>
									<td><?php echo ($list['province']); ?></td>
									<td><?php echo ($list['city']); ?></td>
									<td><?php echo ($list['buy_name']); ?></td>
									<td><?php echo ($list['appellation']); ?></td>
									<td><?php echo ($list['contact_way']); ?></td>
									<td><?php echo ($list['low_price']); ?></td>
									
									<td>
									<input id="over" style="border:0px;width:50px;background-color:white;" value="待联系"/><br/>
									<a href="<?php echo U('offer_del?id='.$list['id']);?>">删除</a>
									</td>
	  ...
	  //给循环的值追加点击事件
		 $(document).ready(function(){
			$("[id=over]").each(function(){
				$(this).click(function(){
				var data = new FormData(document.getElementById('over'));
						$.ajax({
							url:'<?php echo U("first_consulting");?>',
							data:data,
							type:'post',
							success:function(data) {
								if(data) {
									$(this).css('color','red').val('已完成').attr('disabled','disabled');
								} 
							},
							dataType:'json',
							cache:false, // 关闭缓存
							contentType:false, // 关闭转换格式
							processData:false
						});
					});
				});
