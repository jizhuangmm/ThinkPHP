<?php
namespace Common\WechatSDK;

use Common\WechatSDK\Utils\HttpCurl;
use Common\WechatSDK\Utils\Error;
use Common\WechatSDK\Utils\SHA1;
use Common\WechatSDK\Utils\Xml;
 ...
 * - 数据统计接口（开发中...）
 *
 * @author 		Tonight <127798@qq.cm>
 *
 * Class Api
 * @package Common\WechatSDK
 */
class WechatApi 
{
    // 微信API域名
